...
import { FormControl, Input, Button, Paper, InputLabel, withStyles, Typography, CssBaseline } from "@material-ui/core";
        ...
        return(
            <main className={classes.main}>
                ...
                <Paper className={classes.paper}>
                    <Typography component='h1' variant='h5'>Sende eine Nachricht!</Typography>
                    <form className={classes.form} onSubmit={(e) => this.submitNewChat(e)}>
                        ...
                        <Button fullWidth className={classes.submit} variant='contained' color='primary' type='submit'>Senden</Button>
                    </form>
                    {
